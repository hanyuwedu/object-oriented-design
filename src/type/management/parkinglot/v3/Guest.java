...
import type.management.parkinglot.v3.vehicle.Bus;
import type.management.parkinglot.v3.vehicle.Car;
import type.management.parkinglot.v3.vehicle.SUV;
...
public class Guest {
    public static void main(String[] args) {
        ...
        Ticket ticket3 = parkingLot.park(bus, time2);
        parkingLot.showLeftSpots();
        System.out.println();
        ...
        ticket2 = parkingLot.leave(ticket2, time4);
        System.out.println(ticket2);
        parkingLot.showLeftSpots();
        ...
        ticket1 = parkingLot.leave(ticket1, time5);
        System.out.println(ticket1);
        parkingLot.showLeftSpots();
        System.out.println();
        ...
        Ticket ticket5 = parkingLot.park(prius, time9);
        parkingLot.showLeftSpots();

        parkingLot.showSpots();
        System.out.println();

        ticket3 = parkingLot.leave(ticket3, time10);
        ...
        ticket5 = parkingLot.leave(ticket5, time12);
        parkingLot.showSpots();
